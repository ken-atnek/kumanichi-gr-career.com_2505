...
export const scheduleList: ScheduleData[] = [
  {
    ...
    schedule: [
      ...
      {
        time: '15:00',
        activity: 'クライアントのHP制作についてデザイナーとZOOM会議',
      },
  ...
  {
    image: Img03,
    title: '共創プロジェクト室　中堅男性社員の1日',
    schedule: [
      { time: '09:00', activity: '出社・メール確認・会議' },
      { time: '09:30', activity: '共創プロジェクトチーム会議' },
      {
        time: '10:30',
        activity: '熊本県内行政機関との打ち合わせ（受託事業等について）',
      },
      { time: '12:00', activity: '昼食' },
      {
        time: '13:30',
        activity: '熊本市内行政機関各部局との打ち合わせ（全国事業について等）',
      },
      { time: '16:00', activity: '行政事業に関する関係協力会社との打ち合わせ' },
      {
        time: '17:00',
        activity: 'チームミーティング、メール対応、社内各種資料作成',
      },
      { time: '18:00', activity: '退社' },
    ],
  },
