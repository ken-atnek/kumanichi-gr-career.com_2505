/* =======================================
 * 熊日メディアコム  HEADER
 * URL: src/components/yusou-career/common/Header.tsx
 * Created: 2025-06-30
 * Last updated: 2025-06-30
 * ======================================= */
'use client';
import styles from '@/styles/components/common/Header.module.scss';
import Logo from '@/assets/images/yusou-career/logo.webp';
...
const Header = () => {
  ...
  return (
    ...
    >
      <article className={styles.yusou}>
        <Link href="/" className={styles.yusouH1}>
          <h1>
            <Image src={Logo} alt="熊日サービス開発株式会社" />
          </h1>
          <p>株式会社熊日メディアコム</p>
        </Link>
        <nav
