/* =======================================
 * 熊日広告社 HEADER
 * URL: src/components/koh-career/common/Header.tsx
 * Created: 2025-06-26
 * Last updated: 2025-06-26
 * ======================================= */
'use client';
import styles from '@/styles/components/common/Header.module.scss';
import Logo from '@/assets/images/koh-career/logo.webp';
...
const Header = () => {
  ...
  return (
    ...
    >
      <article className={styles.koh}>
        <Link href="/" className={styles.kohH1}>
          <h1>
            <Image src={Logo} alt="株式会社熊日広告社" />
          </h1>
          <p>株式会社熊日広告社</p>
        </Link>
        <nav
