...
export const scheduleList: ScheduleData[] = [
  {
    ...
    schedule: [
      ...
      { time: '13:00', activity: '撮影終了、ランチをして休憩' },
      { time: '14:00', activity: '後日行うライブ配信の打ち合わせ' },
      { time: '16:30', activity: '編集作業、判断に迷う部分をチームメンバーに相談' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '10:00', activity: '新規案件打ち合わせ、簡易クリエイティブ制作' },
      { time: '12:00', activity: 'オフィス近くでランチ' },
      { time: '13:00', activity: '広告運用提案資料の作成' },
      { time: '14:00', activity: '外出中のビジネス担当とのチャットやWEBミーティング対応' },
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: '10:00', activity: '制作チームの進捗確認・状況確認・クライアントとWEBミーティング' },
      { time: '12:00', activity: '社食限定ランチ' },
      { time: '13:00', activity: '広告運用提案レポートの確認、クライアントへの説明' },
